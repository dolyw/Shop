(function(window,document){
	...
	var create = function(id,toId){
		...
		parObj.find("li").each(function(index){
			...
			var nowImg = obj.data("src");
			var nowOri = obj.data("original");
			...
			if(index == '0'){
                ...
                adHtml = adHtml
                +'<li>'
                +'      <a href="'+ nowUrl +'"><img class="lazyimg" width="1000px" src="'+ nowImg +'"  data-original="'+ nowOri +'" alt="'+ nowTit +'"/></a>'
                +'</li>';
			}else{
				//alert(index);
				adHtml = adHtml
				+'<li>'
				+'	<a href="'+ nowUrl +'"><img class="lazyimg" width="1000px" src="'+ nowOri +'" alt="'+ nowTit +'"/></a>'
				+'</li>';
			}
