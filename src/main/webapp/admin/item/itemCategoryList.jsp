...
<body>
	...
	<script >
		...
		$('#table').bootstrapTable({
		    url: '${ctx}/admin/itemCategory/getList',
		    method: 'post',
	            ...
	            events: window.operateEvents = {
	                    'click .RoleOfdelete': function (e, value, row, index) {
	                    	swal({
	            	  			...
	            	  			$.ajax({
	            		            type: 'POST',
	            		            url: '${ctx}/admin/itemCategory/delete',
	            		            data: {
	            		                id: row.id
	            		            },
	            		            dataType: 'json',
	            		                	...
	            		                	swal(
	            				               	{   
	            		               		      ...
	            		               		      confirmButtonText: "确定"
	            			               		      ...
	            			               		      function () {
	            			               		      	location.href='${ctx}/admin/itemCategory/list';
	            			               		      }
	            			             		)
	            		                }
	            		            },
	                    ...
	                    'click .RoleOfedit': function (e, value, row, index) {
	                    	if (row.id == undefined || row.id == null || row.id == '') {
	            	            window.location.href = '${ctx}/admin/itemCategory/list';
	            	        } else {
	            	        	$.ajax({
	            		            type: 'POST',
	            		            url: '${ctx}/admin/itemCategory/edit',
	            		            data: {
	            		                id: row.id
	            		            },
	            		            dataType: 'json',
	...
	<script>
		...
		function save() {
			if($('#name').val().length <= 0){
	        	...
	        	$.ajax({
		            type: 'POST',
		            url: '${ctx}/admin/itemCategory/save',
		            data: $('#form').serialize(),
		            dataType: 'json',
		            success: function (data) {
		                if (data.success) {
