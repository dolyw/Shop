...
<div class="container">
    <div class="col-md-6 col-md-offset-3">
        <form id="form" name="form">
			...
			<div class="form-group has-feedback">
                ...
                <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
				  <ul class="layui-tab-title">
				    ...
				    <li class="layui-this">短信验证码登录</li>
            ...
            <div class="form-group has-feedback">
                <div class="input-group">
                    ...
                    <input id="idcode-btn" class="form-control" placeholder="短信验证码" maxlength="4" type="text">
        ...
        <div class="form-group">
            <input class="form-control btn btn-primary" value="立&nbsp;&nbsp;即&nbsp;&nbsp;登&nbsp;&nbsp;录" id="submit" type="submit" >
        </div>
    </div>
</div>
	...
	$('#loadingButton').click(function(e) {
	    if (!check.every(function(value) {
            ...
            if (!check[0]) {
            	...
            	if (check[0] && $(loadingButton).html() == '发送验证码'){
        	    	//alert("d");
        	    	$.ajax({
        	            type: 'POST',
        	            url: '${ctx}/user/getSms',
